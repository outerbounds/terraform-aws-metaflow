...
| <a name="input_ui_static_container_image"></a> [ui\_static\_container\_image](#input\_ui_\_static\_container\_image) | Container image for the UI frontend app | `string` | `""` | no |
