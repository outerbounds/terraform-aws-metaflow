...
| <a name="metadata_service_ephemeral_storage"></a> [metadata\_service\_ephemeral\_storage](#metadata\_service\_ephemeral\_storage) | Disk space for disk ECS task [21-200] | `number` | `21` | no |
