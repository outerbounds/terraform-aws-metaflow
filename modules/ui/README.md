...
| <a name="input_elb_connection_logging_enabled"></a> [elb\_connection\_logging\_enabled](#input\_elb\_connection\_logging\_enabled) | Enable connection logging for all Elastic Load Balancers | `bool` | `false` | no |
