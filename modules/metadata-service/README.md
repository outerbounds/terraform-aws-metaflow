...
[metadata\_service\_ephemeral\_storage](#metadata\_service\_ephemeral\_storage) | Disk space for disk ECS task [21-200] | `number` | `21` | no |
| <a name="input_metadata_service_enable_api_basic_auth"></a> 
